...
#'
#' @return A one-row tibble with columns \code{n_tests}, \code{n_below},
#'   \code{pct_below}, \code{expected_below}, \code{n_below_fdr},
...
#' @return A list with \code{p_value} (non-missing p-values) and \code{keep}
#'   (logical index of retained rows in \code{x}).
#' @keywords internal
#' @noRd
